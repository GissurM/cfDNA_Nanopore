...
The code expects a bam file input, a matching .fa index to the bam files and a chromosome list so make sure to have those on hand. If you trust your trim step completely run the normal version. In case you suspect poor or problematic trimming switch to the softclip version to rely more on the alignment rather than the basecall/trim. 
